            ...
            <Card className="bg-transparent shadow-none border-none transition-all duration-300">
                ...
                <div id="feedback-box" className="mt-4 space-y-2 text-sm min-h-[100px]">
                    ...
                    feedbackList.length > 0 ? (
                        ...
                        return (
                            <div key={index} className={`flex items-center gap-2 p-2 rounded-md ${isGood ? 'bg-green-100 dark:bg-green-900/50' : 'bg-amber-100 dark:bg-amber-900/50'}`}>
          ...
          <SidebarGroupContent>
            <Card className="bg-transparent shadow-none border-none transition-all duration-300">
                ...
                {generatedPlan && (
                    ...
                    <AlertDescription className="whitespace-pre-wrap font-mono">{generatedPlan}</AlertDescription>
                    </Alert>
                )}
                </CardContent>
            </Card>
