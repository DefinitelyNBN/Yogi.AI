...
-   **File:** `src/features/dashboard/hooks/useYogaDashboard.ts`
...
-   **File:** `src/features/pose-correction/components/PoseCorrectionClient.tsx`
-   **What it does:**
...
-   **File:** `src/features/pose-correction/lib/pose-analyzer.ts`
...
-   **File:** `src/features/custom-poses/components/AddPoseForm.tsx`
...
-   **File:** `src/features/custom-poses/flows/generate-pose-rules.ts`
...
-   **File:** `src/features/custom-poses/flows/generate-pose-image.ts`
...
-   **File:** `src/features/dashboard/components/layout/PlanPane.tsx`
-   **What it does:** Contains the UI for the user to enter their goal and see the generated plan.
-   **File:** `src/features/yoga-plan/flows/generate-yoga-plan.ts`
...
-   **File:** `src/features/pose-correction/flows/generate-audio-feedback.ts`
